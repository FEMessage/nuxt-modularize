export default async function ({ store }) {
  ...
  void (function updateStore() {
    resolveStoreModules(require('../modules/domain-member/store/member/state.js'), 'domain-member/store/member/state.js')
    resolveStoreModules(require('../modules/domain-member/store/index.js'), 'domain-member/store/index.js')
    resolveStoreModules(require('../modules/domain-goods/store/index.js'), 'domain-goods/store/index.js')
